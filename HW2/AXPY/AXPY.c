...
//performance regarding of different combination(time, with n = 100)
//orginal loop: 217.00 (slowest)
//vector(32): 137.00
//gang: 84.00 (most effective! parallel, distribute the work into many worker groups)
//collapse(2): 171.00
